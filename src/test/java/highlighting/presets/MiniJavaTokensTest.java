...
class MiniJavaTokensTest {
  ...
  void keywordMatchesOnlyWholeWords() {
    var regions =
        regionsForColour(
            "class public private return null new newValue classroom",
  ...
  void javadocCommentMatchesSeparately() {
    var regions =
        regionsForColour("/** public class return */", MiniJavaColours.JAVADOC_COMMENT_COLOUR);
